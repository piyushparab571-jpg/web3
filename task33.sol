...
contract ReturnCalldataValueVul {
    ...
    /*
        FUNCTION:
        Accept uint array through calldata,
        copy it into memory,
        reverse the array,
        and return the reversed array.
    */
    function returnReversedArray(
        uint256[] calldata _numbers
    )
        external
        pure
        returns (uint256[] memory)
    {
        /*
            ...
            unlike calldata arrays.
        */
        uint256[] memory reversed = new uint256[](
            _numbers.length
        );
        ...
        */
        ...
        /*
            RETURN THE MODIFIED MEMORY ARRAY
        */
        return reversed;
    }
}
