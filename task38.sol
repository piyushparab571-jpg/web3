...
/*
=====================================================
TRANSACTION ATOMICITY VULNERABILITY
=====================================================
*/
contract TransactionAtomicityVul {
    ...
    /*
        Address of external token contract.
    */
    ...
    */
    ...
    1. Update state
    2. Make external token transfer
    3. Revert
    ...
    */
    ...
    Validation is performed BEFORE the external call.
    */
    function safeExecution(
        uint256 _amount
    )
